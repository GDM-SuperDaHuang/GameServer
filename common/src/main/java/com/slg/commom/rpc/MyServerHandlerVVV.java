...
import com.slg.commom.annotation.RouteExecution;
...
public class MyServerHandlerVVV extends SimpleChannelInboundHandler<MSG.Message> implements Process {
    private static final Logger logger = LoggerFactory.getLogger(MyServerHandlerVVV.class);
