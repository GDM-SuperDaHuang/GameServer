...
public class SentUtil {
    ...
    private ConcurrentHashMap<Integer, CompletableFuture<ByteBufferMessage>> pendingRequests = new ConcurrentHashMap<>();
...
//    }
    ...
    public CompletableFuture<ByteBufferMessage> getPendingRequests(int cid) {
