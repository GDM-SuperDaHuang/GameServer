...
@Component
public class MsgDecodeTemp extends ByteToMessageDecoder {
    //    Map<Long, Long> sessionMap = new ConcurrentHashMap<>();
    private short length = 0;

    public MsgDecodeTemp() {
    }

    private HandleBeanDefinitionRegistryPostProcessor postProcessor;
    public MsgDecodeTemp(HandleBeanDefinitionRegistryPostProcessor postProcessor) {
