...
// * 确保之前的包完整性
// */
//public class MessageCodec extends MessageToMessageCodec<ByteBuf,GDM.Message> {
//    Map<Long,Long> sessionMap = new ConcurrentHashMap<>();
//
//    //出
//    @Override
//    protected void encode(ChannelHandlerContext ctx, GDM.Message msg, List<Object> list) throws Exception {
